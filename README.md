...
- [s3b4hjr/philosophy-mcp]([https://github.com/alvesribeirof/architecture-analysis-mcp](https://github.com/s3b4hjr/philosophy-mcp)) `🐍` `☁️`An MCP server for a multilingual philosophy corpus — glossary, syntheses, thinker profiles, and articles in Portuguese, English, and Spanish. **by [@s3b4hjr](https://github.com/s3b4hjr)**
